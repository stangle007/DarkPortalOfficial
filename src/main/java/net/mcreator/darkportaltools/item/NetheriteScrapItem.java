...
public class NetheriteScrapItem extends DarkPortalToolsModElements.ModElement {
	@ObjectHolder("dark_portal_tools:netherite_scrap")
	public static final Item block = null;
	public NetheriteScrapItem(DarkPortalToolsModElements instance) {
		super(instance, 27);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("scrap of netherite"));
		}
	}
}
