...
public class ShopkeeperEntity extends DarkPortalToolsModElements.ModElement {
	public static EntityType entity = null;
	public ShopkeeperEntity(DarkPortalToolsModElements instance) {
		super(instance, 56);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.95f)).build("shopkeeper")
						.setRegistryName("shopkeeper");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -10079488, -16750951, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("shopkeeper"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.AMBIENT).add(new Biome.SpawnListEntry(entity, 1, 1, 1));
		}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new VillagerModel(0), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity1) {
				return new ResourceLocation("dark_portal_tools:textures/vindication_villager.png");
			}
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Shopkeeper"));
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Shopkeeper");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CustomShopkeeperShopGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
